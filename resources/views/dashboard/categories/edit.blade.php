...
<div class="w-75">
    ...
    <form method="POST" action="/dashboard/categories/{{ $category->id }}">
        ...
        <div class="form-group">
            ...
            <textarea name="headline" id="category-headline" class="form-control">{{ $category->headline }}</textarea>
        </div>
        <div class="form-group">
            <label for="category-caption">キャプション</label>
            <textarea name="caption" id="category-caption" class="form-control">{{ $category->caption }}</textarea>
        </div>
        <div class="form-group">
